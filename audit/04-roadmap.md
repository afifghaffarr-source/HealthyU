...
| God-file refactor (types, sidebar)                  | ⚠️ TODO                             | (optional) — `scanMisc.functions.ts` DONE 2026-06-16, split into 5 domain files (Location, AICoach, Gamification2, Subscription, ThemeInvite) — `ui/sidebar.tsx` removed 2026-06-16 (745 LOC dead code, shadcn template never imported)                   |
