    ...
    <main className="min-h-screen bg-background text-foreground relative overflow-x-clip">
          ...
          >
            ...
            <div className="space-y-3 h-full flex flex-col">
              <div className="glass rounded-2xl p-4 border border-white/20">
                ...
                >
                  1.420{" "}
                  <span className="text-sm text-muted-foreground font-normal">/ 1.800 kkal</span>
                </p>
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <div
                    key={k}
                    className="glass rounded-xl p-2.5 text-center border border-white/15"
                  >
              ...
              <div className="glass rounded-2xl p-4 border border-primary/20 flex-1 relative overflow-hidden">
                ...
                <p className="text-xs text-foreground/85 leading-relaxed">
                  Hampir sampai target! Tambah <strong>ayam panggang 100g</strong> sore ini biar
                  protein full. 💪
                </p>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-5 md:px-8 py-16">
        <div className="flex items-end justify-between mb-6">
          ...
          <Link to={ctaPrimary} className="hidden sm:inline text-sm font-semibold text-primary">
            Lihat semua →
          </Link>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
