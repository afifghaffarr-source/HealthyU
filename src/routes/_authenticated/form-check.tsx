...
import { analyzeFormCheck } from "@/features/scan/lib/scanBatch12.functions";
    ...
    <div className="min-h-dvh pb-24 bg-background">
      ...
      <main className="max-w-md mx-auto px-4 pt-4 space-y-3">
        ...
        <textarea
          ...
          rows={4}
          placeholder="Deskripsikan gerakanmu..."
          className="w-full px-3 py-2 rounded-lg border bg-background"
        />
        <button
          onClick={() => mut.mutate()}
          disabled={mut.isPending || desc.length < 5}
        ...
        {f && (
          <div className="rounded-xl border bg-card p-3 space-y-2 text-sm">
            <p>
              Skor: <span className="font-bold">{f.score}/10</span>
            </p>
            {f.mistakes && (
              <div>
