        ...
        {data?.report && (
          <>
            ...
            <div className="grid grid-cols-2 gap-2">
              <button onClick={downloadPdf} className="rounded-xl bg-primary text-primary-foreground py-2.5 inline-flex items-center justify-center gap-2 text-sm font-semibold">
                <FileText className="size-4" /> PDF
              </button>
              <button onClick={downloadTxt} className="rounded-xl border py-2.5 inline-flex items-center justify-center gap-2 text-sm">
