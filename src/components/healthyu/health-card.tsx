...
const toneStyles: Record<NonNullable<Props["tone"]>, { bg: string; fg: string }> = {
  ...
  orange: {
    bg: "bg-[color-mix(in_oklch,var(--health-orange-500)_15%,transparent)]",
    fg: "text-[var(--health-orange-700)]",
  },
  blue: {
    bg: "bg-[color-mix(in_oklch,var(--health-blue-500)_15%,transparent)]",
    fg: "text-[var(--health-blue-500)]",
  },
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2">
        ...
        {Icon && (
          <span
            className={cn("inline-flex size-8 items-center justify-center rounded-xl", t.bg, t.fg)}
          >
