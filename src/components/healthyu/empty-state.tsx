  ...
  return (
    <div className={cn("flex flex-col items-center justify-center text-center py-10 px-6 gap-3", className)}>
      ...
      <div className="space-y-1">
        <p className="font-semibold text-sm" style={{ fontFamily: "var(--font-display)" }}>{title}</p>
        {description && <p className="text-xs text-muted-foreground max-w-xs mx-auto">{description}</p>}
      </div>
